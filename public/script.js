let ccNumberInput = document.querySelector(".cc-number-input"),
  ...
  highlightCC = (ccValue) => {
    ...
    cardTypeText.innerText = "не известно";
    cardNiceTypeText.innerText = "не известно";
    isCardPotentiallyValidText.innerText = "нет";
    isCardValidText.innerText = "нет";
    ...
    if (cardInfo) {
      ...
      isCardPotentiallyValidText.innerText = cardInfo.isPotentiallyValid
        ? "да"
        : "нет";
      isCardValidText.innerText = cardInfo.isValid ? "да" : "нет";
    }
